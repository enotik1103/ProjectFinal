  ...
  <div class="modal modal--column">
    <div class="modal__container">
      ...
      <form class="form--column">
        <input v-model="name" type="text" id="title-column" name="title" placeholder="Название" />
        <input v-model="description" type="text" id="title-column" name="title" placeholder="Описание" />
        <button @click="newBoardHandler" type="button">Создать</button>
...
export default defineComponent({
  ...
  methods: {
    ...
    ...mapActions({
      ...
      newBoard: 'boardsStore/newBoard',
      editBoard: 'boardsStore/editBoard'
    }),

    async newBoardHandler() {
      if (this.name.trim() === '') {
